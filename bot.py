...
# =========================================================
#   ADMIN MESSAGE (يرسل إلى القروب المحدد)
# =========================================================
...
# =========================================================
#   CALLBACK HANDLER (التحكم بالزر داخل القروب)
# =========================================================
...
def handle_callback(data, callback):
    ...
    # التحقق أن التفاعل صادر من القروب المحدد أو الخاص بالأدمن
...
def process_update(data, update):
    ...
    if "message" in update:
        ...
        # استقبال إعلان شخصي مرسل من داخل القروب المحدد
        if (
        ...
        # أمر تفعيل اللوحة من داخل القروب
        if (
            id_str == str(ADMIN_ID) and
            text == "/start"
        ):
        ...
        # استقبال رسائل البدء من المستخدمين العاديين بالخاص
        if (
...
if __name__ == "__main__":
    ...
    while True:
        ...
        time.sleep(0.2)
# تشغيل سيرفر فلاسك الوهمي أولاً لإبقاء الرابط نشطاً
keep_alive()

# تشغيل البوت الأساسي لكي يبدأ باستقبال الرسائل والرد عليها
if __name__ == "__main__":
